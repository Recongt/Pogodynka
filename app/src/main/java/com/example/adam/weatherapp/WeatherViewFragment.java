...
import com.example.adam.weatherapp.modelDanych.CurrentWeather;
import com.example.adam.weatherapp.modelDanych.Main;
import com.example.adam.weatherapp.modelDanych.Weather;
...
//    private IFragmentContainer fragmentContainer;
    ...
    public WeatherViewFragment(String x)
    {
        this._cityName = x;
    }
